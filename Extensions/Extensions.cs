...
namespace Extensions
{
    public static class MyExtensions
    {
        ...
        /// <summary>Determines if a target string contains a string.</summary>
        /// <param name="target">Target string to be checked</param>
        /// <param name="value">String to be checked if it exists in the target string</param>
        /// <param name="comparison">Comparison type</param>
        /// <returns></returns>
        public static bool Contains(this string target, string value, StringComparison comparison) => target.IndexOf(value, comparison) >= 0;
